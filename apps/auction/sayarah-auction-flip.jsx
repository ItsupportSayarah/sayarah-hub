      ...
      <div className="login-form-panel" style={{
        ...
        <div className="login-form-box" style={{ width: "100%", maxWidth: 380, position: "relative", zIndex: 1, animation: "slideUp 0.6s ease" }}>
            ...
            <div style={{ textAlign: "center", marginTop: 4 }}>
              ...
              {showForgot && (
                <div style={{ marginTop: 10, background: "linear-gradient(135deg, #EFF6FF, #DBEAFE)", border: "1px solid #BFDBFE", borderRadius: 10, padding: "12px 16px", fontSize: 12, color: BRAND.blue, lineHeight: 1.6, animation: "slideUp 0.3s ease" }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ verticalAlign: "middle", marginRight: 6 }}><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
          ...
          <div style={{ textAlign: "center", marginTop: 36, paddingTop: 20, borderTop: `1px solid ${BRAND.grayLight}` }}>
            <p style={{ fontSize: 11, color: BRAND.gray, margin: 0 }}>Powered by <span style={{ fontWeight: 800, color: BRAND.red }}>Sayarah Inc</span></p>
          </div>
        </div>
      </div>
    </div>
...
<div class="header">
  <div><img src="/logo.png" class="logo-img" alt="Auto Trade Hub" /><div class="logo-sub">POWERED BY SAYARAH INC</div></div>
  <div class="inv-meta">
...
<div class="footer">
  Generated by Auto Trade Hub · Powered by Sayarah Inc · ${today} · Invoice ${invoiceNum}
</div>
</body></html>`;
...
<div class="header"><img src="/logo.png" style="height:64px;object-fit:contain;margin-bottom:8px" alt="Auto Trade Hub" /><p style="font-size:11px;color:#999;letter-spacing:0.12em;margin-bottom:12px">POWERED BY SAYARAH INC</p><h2 style="color:#333;font-size:18px">${r.label} — Performance Report</h2></div>
<div class="grid">
            ...
            <div className="app-header-actions" style={{ display: "flex", alignItems: "center", gap: 4 }}>
              ...
              <div style={{ position: "relative" }}>
                <button onClick={() => setShowSearch(p => !p)} style={{
                  ...
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
                </button>
                {showSearch && (
                  <div className="search-dropdown" style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, width: 380, background: BRAND.white, borderRadius: 14, boxShadow: "0 20px 60px rgba(0,0,0,0.25)", border: `1px solid ${BRAND.grayLight}`, zIndex: 200, overflow: "hidden" }}>
                    <div style={{ padding: "12px 16px", borderBottom: `1px solid ${BRAND.grayLight}`, display: "flex", alignItems: "center", gap: 8 }}>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={BRAND.gray} strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
                      ...
                      <div style={{ maxHeight: 320, overflowY: "auto" }}>
                        {searchResults.length === 0 ? (
                          ...
                          <div key={i} onClick={() => { setTab(r.type === "vehicle" ? "Inventory" : r.type === "expense" ? "Inventory" : "Analytics"); setShowSearch(false); setSearchQuery(""); }} style={{ padding: "10px 16px", borderBottom: `1px solid ${BRAND.grayLight}`, cursor: "pointer", display: "flex", alignItems: "center", gap: 10, transition: "background 0.15s" }}>
                            <span style={{ fontSize: 16 }}>{r.type === "vehicle" ? "🚗" : r.type === "expense" ? "💰" : "📄"}</span>
                            <div>
              ...
              <button onClick={toggleDarkMode} title={darkMode ? "Light Mode" : "Dark Mode"} style={{
                ...
                {darkMode
                  ? <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FBBF24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>
            ...
            <nav className="app-nav" style={{ display: "flex", gap: 0, alignItems: "center", overflowX: "auto" }}>
              {visibleTabs.map(t => {
                ...
                const icons = {
                  ...
                  Pipeline: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>,
                  Inventory: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>,
                  Mileage: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>,
                  ...
                  Reports: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>,
                  Approvals: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>,
